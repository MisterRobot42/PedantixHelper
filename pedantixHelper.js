...
(function() {
    ...
    //Concatenate all the lists into one. Add more lists if needed.
    const wordLists = [commonPrepositions, commonVerbs, commonAdjectives, commonNouns, numbers, letterPrefixes, themes];
